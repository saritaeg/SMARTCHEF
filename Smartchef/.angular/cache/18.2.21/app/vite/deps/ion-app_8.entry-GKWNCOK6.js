...
} from "./chunk-AU34DZXB.js";
import {
  isRTL
} from "./chunk-JQCJAYTB.js";
import {
  createLockController
} from "./chunk-F7RNWR2Z.js";
import {
  findIonContent,
  getScrollElement,
...
import {
  attachComponent,
  detachComponent
} from "./chunk-7GJW7W6P.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-2IBINMTO.js";
import {
  transition
} from "./chunk-N2MBWDZF.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-ZKVQE4ZH.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-ZVHGE27B.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-RRXRQDMO.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-D6H3ZaWt-EBP6KYVE.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-KWL3IBMK.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-W2KYFLIX.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-GKWNCOK6.js.map
